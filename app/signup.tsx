...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    ...
    const res = await fetch(
      "https://zappstore-backend.onrender.com/api/user/signup",
      {
        method: "POST",
        headers: {
          ...
          <View style={styles.content}>
            ...
            <View style={styles.accountTypeContainer}>
              ...
              <TouchableOpacity
                style={[
                  styles.accountTypeButton,
                  accountType === "sp" && styles.selectedAccountType,
                ]}
                onPress={() => setAccountType("sp")}
              >
                <Ionicons
                  name="settings-outline"
                  size={24}
                  color={accountType === "sp" ? "#00A3E0" : "#CCCCCC"}
                />
                <Text
                  style={[
                    styles.accountTypeText,
                    accountType === "sp" && styles.selectedAccountTypeText,
                  ]}
                >
                  Service
                </Text>
            ...
            >
              <Text style={styles.signUpButtonText}>
                {loading ? <Spinner size={25} color="white" /> : "Signup"}
              </Text>
            </TouchableOpacity>
